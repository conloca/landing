...
function StackedCopy({ title, body, secondaryCta }: Omit<FeatureCardProps, 'visual' | 'layout' | 'background'>) {
  return (
...
export function FeatureCard({ title, body, secondaryCta, visual, layout, background }: FeatureCardProps) {
