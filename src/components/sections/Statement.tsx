  ...
  return (
    <section className="relative mx-auto max-w-[1440px] px-8 py-32 sm:py-[196px]">
      <div className="relative mx-auto max-w-3xl text-center">
        <FloatingChip className="top-[-3rem] left-[2%]" rotate="-rotate-6" delay={0}>
          <span className="size-[7px] shrink-0 rounded-full bg-[#9AE600] sm:size-[11px]" />
          changes published
        </FloatingChip>
        <FloatingChip
          className="top-[-4.5rem] right-[10%]"
          rotate="rotate-12"
          delay={0.1}
          tile="bg-[#F03C2E]"
        >
        ...
        <h2 className="font-display text-4xl leading-[1] font-black text-stone-900 sm:text-6xl lg:text-7xl">
          ...
          <br />
          <Reveal as="span" className="inline-block text-[#9AE600]" delay={0.08}>
            nothing you don&apos;t
          </Reveal>
        </h2>
      </div>
